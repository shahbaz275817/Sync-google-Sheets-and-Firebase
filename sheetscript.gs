function getEnvironment() {
 var environment = {
   spreadsheetID: "1fQqF1Nxxxxxxxxxxxxxx4EmY4DKyxjfY_efp8Jw",
   firebaseUrl: "https://xxxxxxxx.firebaseio.com/"
 };
 return environment;
}
...
//  Logger.log(_.isEqual(data,dataToImport));
  
  
  var a = Object.getOwnPropertyNames(data);
  var b = Object.getOwnPropertyNames(dataToImport);
  Logger.log(a);
  Logger.log(b);
